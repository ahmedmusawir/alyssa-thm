	...
	<div class="wrapper container-fluid">
		...
		<div class="icon-content">
			...
			<figure class="col-sm-4 col-md-4 col-md-lg">
				...
				<a href="/1-on-1-packages/" target="_blank">
					<img class="img-responsive wow bounceInLeft" src="/wp-content/uploads/2016/10/left.jpg" data-wow-duration="1s" data-wow-delay="0s" alt="">
			...
			<figure class="col-sm-4 col-md-4 col-md-lg">
				...
				<a href="/group-packages/" target="_blank">
					<img class="img-responsive wow zoomIn" src="/wp-content/uploads/2016/10/middle.jpg" data-wow-duration="1s" data-wow-delay="0s" alt="">
					<article class="text-content"><br>
						Group Packages
					</article>
				</a>
			...
			<figure class="col-sm-4 col-md-4 col-md-lg">
				...
				<a href="#" target="_blank">
					<img class="img-responsive wow bounceInRight" src="/wp-content/uploads/2016/10/right.jpg" data-wow-duration="1s" data-wow-delay="0s" alt="">
					<article class="text-content"><br>
						Join the Tribe
					</article>
				</a>
...
<section id="front-page-blog-block" class="container-fluid">
